codeunit 50300 "GW SMS Entry Executer"
{
    ...
    var
        ...
        Body: Text;
        SalesNotificationMsg: Label 'Dear %1, <br><br> Your order dated %2 is %3 .<br><br> Thank You, <br> -GWH <br><br>';
    ...
    begin
        ...
        _Client.DefaultRequestHeaders.Add('Authorization', StrSubstNo('Bearer %1', SMSConnectorSetup.GetAccessToken()));
